...
var accessRules = [// { re: /company-org-chart.png/, groups: ['04iylrwe113ay6x'], }
];

var verifyAuthorization = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_ref) {
    var user, path, _ref3, groups, cloudidentity, auth, authClient, _iterator, _step, _res$data, group, res;

    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            user = _ref.user, path = _ref.path;
            _ref3 = accessRules.find(function (_ref4) {
              var re = _ref4.re;
            ...
            cloudidentity = google.cloudidentity('v1');
          ...
          case 7:
            ...
            _iterator = _createForOfIteratorHelper$1(groups);
            _context.prev = 10;
          ...
          case 12:
            ...
            group = _step.value;
            _context.next = 16;
            return cloudidentity.groups.memberships.checkTransitiveMembership({
              parent: "groups/".concat(group),
              query: "member_key_id == '".concat(user, "'")
            });

          case 16:
            res = _context.sent;

            if (!(res !== null && res !== void 0 && (_res$data = res.data) !== null && _res$data !== void 0 && _res$data.hasMembership)) {
              _context.next = 19;
              break;
            }
  ...
  return function verifyAuthorization(_x) {
...
var htmlOpen = function htmlOpen(_ref) {
  var path = _ref.path;
...
var commonProcessor = function commonProcessor(render) {
  return /*#__PURE__*/function () {
    var _ref7 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(req, res, next) {
      var ticket, userEmail, path, authorized;
      return regenerator.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 11:
              userEmail = ticket.payload.email; // Cloud storage doesn't like an initial '/', so we remove any.
            ...
            case 15:
              ...
              res.status(403).send("".concat(htmlOpen({
                path: "FORBIDDEN: ".concat(path)
              }), "\n\nYou do not have access to '").concat(path, "'.").concat(htmlEnd()));
